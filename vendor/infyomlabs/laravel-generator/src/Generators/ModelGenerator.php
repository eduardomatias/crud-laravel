...
class ModelGenerator extends BaseGenerator
{
    ...
    private function fillTemplate($templateData)
    {
        ...
        $templateData = str_replace('$ATTRIBUTE_LABEL$', implode(','.infy_nl_tab(1, 2), $this->generateAttributeLabel()), $templateData);
    ...
    private function fillSoftDeletes($templateData)
    {
        if (!$this->commandData->getOption('softDelete')) {
            ...
            $templateData = str_replace('$SOFT_DELETE$', "use SoftDeletes;", $templateData);
    ...
    private function generateAttributeLabel()
    {
        $attributeLabel = [];

        foreach ($this->commandData->fields as $field) {
            $attributeLabel[] = "'".$field->name."' => '".str_replace('_', ' ', $field->name)."'";
        }
